...
class ReportPanel extends Component {
    ...
    getReport = ( index ) => {
        ...
        axios.post( '/getcandidatereport', Data ).then( response => {
            ...
            let pass = true;
            if ( Object.values(response.data).every((x) => x === null) )
            {
                pass = false;
            }
                ...
                <Modal show={this.state.showReportModal} close={this.reportModal} wid="60%">
                    {
                        ...
                        <div className="center_info d-flex justify-content-between align-items-center border p-2">
                            <div className="w-75">
                                <div className="d-flex justify-content-start align-items-center w-100">
                                    ...
                                    <p className="mb-0">Karachi Diagnostic Center</p>
                                </div>
                                <div className="d-flex justify-content-start align-items-center w-100">
                                    <p className="font-weight-bold mb-0 mr-1">Address: </p>
                                    <p className="mb-0">Sadar, Karachi</p>
                                </div>
                                <div className="d-flex justify-content-start align-items-center w-100">
                                    <div className="d-flex justify-content-start align-items-center w-100">
                                        <p className="font-weight-bold mb-0 mr-1">Phone: </p>
                                    <p className="mb-0">38742384923</p>
                                    </div>
                                    <div className="d-flex justify-content-start align-items-center w-100">
                        ...
                        <div className="container-fluid">
                            <div className="row">
                                ...
                                <div className="col-lg-2 col-md-2 col-sm-12 border d-flex justify-content-center align-items-center" style={ { 'position' : 'relative' } }>
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-5 col-md-5 col-sm-12">
                                    <div className="row">
                                        ...
                                        <div className="col-lg-4 col-md-2 col-sm-4 border">
                                            <p className="mb-0 w-100 text-uppercase text-center">status</p>
                                        </div>
                                        <div className="col-lg-4 col-md-6 col-sm-4 border">
                                        ...
                                        <div className="search_options d-grid">
                                            <div className="d-flex justify-content-center tab-container">
                                                {/* <div className="row sec" 
                                                    onClick={ () => this.ChangeToTextField('SByToken') }
                                                >
                                                ...
                                                <div className="row sec" 
                                                    onClick={ () => this.ChangeToTextField('SByDate') }
                                                >
                                                    <div className="col-4 pr-0 text-center">
                                                ...
                                                {/* <div className="row sec" 
                                                    onClick={ () => this.ChangeToTextField('SByShift') }
                                                >
                                                    <div className="col-4 pr-0 text-center">
