...
class ToCandidate extends Component {
    ...
    componentDidMount()
    {
        ...
        let getOriginalToken = URL.substring(8, 10);
    ...
    CandidateDataEntry = ( event ) => {
        ...
        {
            this.props.error("Please Take Your Photo");
            return false;
        }
    ...
    render()
    {
        ...
        return(
            ...
            <>
                ...
                <form onSubmit={ this.CandidateDataEntry } className="w-100 d-grid ToCandidate">
