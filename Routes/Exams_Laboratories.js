        ...
        ( err, rslt ) => {
            ...
            }else
            {
                ...
                db.query(
                    ...
                    [rslt[0].candidate_id, height, weight, bmi, bp1 + " / " + bp2, pulse, pr, unaidedDistantRtEye, unaidedDistantLtEye, aidedDistantRtEye, aidedDistantLtEye, unaidedNearRtEye, unaidedNearLtEye, aidedNearRtEye, aidedNearLtEye, colorVision, RightEar, LeftEar, Insertor, date, fullTime, 'Exam 1 data inserted', logger, date, fullTime],
                    (err, rslt) => {
            ...
            }else
            {
                ...
                if( rslt[0].candidate_id != undefined )
                {
                    ...
                    db.query(
                        ...
                        [ rslt[0].candidate_id, generalAppearance, cardioVascular, respiratory, ent, Abdomen, hernia, hydrocele, exremities, back, skin, cns, deformities, speech, behaviour, orientation, memory, concentration, mood, thoughts, others, inserter, date, fullTime, 'Exam 2 data inserted', logger, date, fullTime ],
                        ( err, rslt ) => {
        ...
        ( err, rslt ) => {
            ...
            else
            {
                ...
                if( rslt[0] != undefined )
                {
                    ...
                    db.query(
                        "INSERT INTO polio_status(status, date, insert_by, insert_date, insert_time, candidate_id) VALUES (?,?,?,?,?,?); INSERT INTO mmr1_status(status, date, insert_by, insert_date, insert_time, candidate_id) VALUES (?,?,?,?,?,?); INSERT INTO mmr2_status(status, date, insert_by, insert_date, insert_time, candidate_id) VALUES (?,?,?,?,?,?); INSERT INTO meningococcal_status(status, date, insert_by, insert_date, insert_time, candidate_id) VALUES (?,?,?,?,?,?); INSERT INTO covid_status(status, date, insert_by, insert_date, insert_time, candidate_id) VALUES (?,?,?,?,?,?);",
                        [Polio, PolioDate, Inserter, date, fullTime, rslt[0].candidate_id, MMR1, MMR1Date, Inserter, date, fullTime, rslt[0].candidate_id, MMR2, MMR2Date, Inserter, date, fullTime, rslt[0].candidate_id, Meningococcal, MeningococcalDate, Inserter, date, fullTime, rslt[0].candidate_id, Covid, CovidDate, Inserter, date, fullTime, rslt[0].candidate_id],
                        ( err, result ) => {
