...
app.post( '/gettokendata', ( req, res ) => {
    ...
    db.query(
        "SELECT * FROM candidate_info LEFT JOIN candidate_images ON candidate_info.candidate_id = candidate_images.candidate_id UNION SELECT * FROM candidate_info RIGHT JOIN candidate_images ON candidate_info.candidate_id = candidate_images.candidate_id",
        ( err, rslt ) => {
